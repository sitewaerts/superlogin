...
module.exports = function (configData, passport, userDB, couchAuthDB) {
  ...
  var userDesign = extend(true, {}, require('../designDocs/user-design'));
  userDesign = util.addProvidersToDesignDoc(config, userDesign);
  var _initPromise = seed(userDB, userDesign).then(function(){_initPromise = BPromise.resolve(); return _initPromise;});
