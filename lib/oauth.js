...
module.exports = function(router, passport, user, config) {
  ...
  function isValidCustomCallbackUri(uri)
  {
    ...
    // accept cdx skin login redirect uri like "https://cloud.cleverdox.de/app/main/adl/12313/de.cleverdox.demo"
    return /^https:\/\/[^/]+\/app\/main\/adl\/[a-z0-9]{2,}\/login\/([a-z]{2,}\.[a-z]{2,}\.[a-z]{2,}[a-z.]*)|false$/.test(uri);
